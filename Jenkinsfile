pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = 'c56b41a6-fb35-4914-9927-19529cc300ee'
    ...
    stages {
        ...
        stage('Deploy staging') {
            ...
            script {
                env.STAGING_URL = sh(script: "node_modules/.bin/node-jq -r '.deploy_url' deploy-output.json", returmStdout: true)
            }
        }
        ...
        stage('Prod E2E') {
            ...
            environment {
                CI_ENVIRONMENT_URL = 'https://gilded-clafoutis-b6de0dg.netlify.app'
            }
